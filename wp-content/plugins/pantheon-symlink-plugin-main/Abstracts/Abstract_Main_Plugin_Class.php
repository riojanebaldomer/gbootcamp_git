<?php
namespace PANTHEONSYMLINKS\Abstracts;
...
abstract class Abstract_Main_Plugin_Class
{
     ...
     * 
     * When adding a public model, and them to the "_all_models" array first via the "add_to_all_plugin_models" function
     * for them to be ran.
     * 
     * Then add them to "_models" array via the "add_to_public_models" function for them to be accessible to the outside
     * world.
     * 
     * E.g. PANTHEONSYMLINKS->Public_Model->some_function();
     * 
     * @since 2.0.0
     * @access protected
     * @var array
    ...
    /**
     * Property that houses an array of all "public helper classes" of the plugin. Can be accessed and utilized by
     * external entities via the main plugin class.
     * 
     * @since 2.0.0
     * @access protected
     * @var array
